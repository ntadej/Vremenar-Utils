...
from typing import Any, Dict, Generator, List, Optional, TextIO, cast
...
BRIGHTSKY_CACHE: Path = Path.cwd() / '.cache/brightsky/MOSMIX_S_LATEST_240.kmz'
...
def process_mosmix(
    ...
    with BatchedPut(db) as batch:
        parser = MOSMIXParserFast(path=BRIGHTSKY_CACHE, url=None)
